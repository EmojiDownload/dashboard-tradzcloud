...
export const config: AppConfig = {
  ...
  icon: BotIcon,
  inviteUrl:
    'https://discord.com/oauth2/authorize?client_id=1082606882784555058&response_type=code&redirect_uri=https%3A%2F%2Fdashboard-tradzcloudv1.vercel.app%2Fapi%2Fauth%2Fcallback&scope=identify+guildsuth%2Fcallback&scope=identify',
  guild: {
